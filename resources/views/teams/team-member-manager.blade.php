    ...
    @if (Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-form-section submit="addTeamMember">
                <x-slot name="title">
                    {{ __('Add Member to Class') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Add member to your class, allowing them to access your learning material and resources.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Please provide the email address of the person you would like to add to this class. The email address must be associated with an existing account.') }}
                        </div>
                    </div>
    ...
    @if ($team->users->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="description">
                    {{ __('All of the people that are part of this class.') }}
                </x-slot>
