...
<div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <h3 style="color:black">Upload Resources to IPFS</h3>
            ...
            <div class="card" style="box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;border-radius: 5px;">
                <div class="card-body" >
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            {{-- <div class="form-group">
                                <label class="control-label" style="font-weight:500">Thumbnail Name</label>
                                <input wire:model="thumbnail_name" type="text" id="thumbnail_name" name="thumbnail_name" class="form-control" >
                                @error('thumbnail_name') <span class="error">{{ $message }}</span> @enderror
                            </div> --}}
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            @error('file_type') <span class="error" style="color:red"><b>{{ $message }}</b></span> @enderror
                        </div>
                    </div>
                    <div class="row">
                        {{-- <div class="col-md-4"> --}}
