                        ...
                        <div class="navbar-header">
                            {{-- <a class="navbar-brand" href="index.html"> --}}
                                ...
                                {{-- <span> --}}
                                 ...
                                 {{-- <img src="img/TVETXRlogo.png" href="{{ url('/login') }}" alt="homepage" class="dark-logo" style="width:200px;height:75px;display: inline;" />
                                </span> --}}
                            {{-- </a> --}}
                                ...
                                @if (auth()->user()->role == 'admin')
                                    ...
                                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Courses </span></a>
                                        <ul aria-expanded="false" class="collapse">
                                            ...
                                            <li class="nav-small-cap" style="padding-left:0px">USING LOCAL</li>
                                            <li><a href="{{URL::to('coursefile')}}">Add Local Resources to Course</a></li>

                                            <li class="nav-small-cap" style="padding-left:0px">USING IPFS</li>
                                            <li><a href="{{URL::to('uploadserver')}}">Upload Resources to IPFS</a></li>

                                            <li><a href="{{URL::to('paidresources')}}">Get IPFS Resources</a></li>
                                    
                                            <li><a href="{{URL::to('classresources')}}">Add IPFS Resources to Course</a></li>
