    ...
    <a-scene embedded arjs>
      ...
      <a-marker type="pattern" url="{{ asset('ar-markers/pattern-AR-marker.patt') }}">
        ...
        {{-- <a-entity id="gltfModel" gltf-model="#3dmodel" 
          ...
          {{-- <a-entity id="gltfModel" gltf-model="url(http://161.139.23.150:8080/ipfs/{{$modelSrc->link_resources}})"  --}}
            <a-entity id="gltfModel" gltf-model="url(https://ipfs.tvetxr.ga:8080/ipfs/{{$modelSrc->link_resources}})" 
