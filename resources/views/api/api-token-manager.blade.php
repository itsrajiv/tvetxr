                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        @foreach (Laravel\Jetstream\Jetstream::$permissions as $permission)
                            <label class="flex items-center">
                                <input type="checkbox" class="form-checkbox" value="{{ $permission }}" wire:model.defer="createApiTokenForm.permissions" style="position: inherit;
                                left: 0px;
                                opacity: 100%;">
    ...
    <x-jet-dialog-modal wire:model="managingApiTokenPermissions">
        ...
        <x-slot name="content">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                @foreach (Laravel\Jetstream\Jetstream::$permissions as $permission)
                    <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox" value="{{ $permission }}" wire:model.defer="updateApiTokenForm.permissions" style="position: inherit;
                        left: 0px;
                        opacity: 100%;">
                        <span class="ml-2 text-sm text-gray-600">{{ $permission }}</span>
                    </label>
